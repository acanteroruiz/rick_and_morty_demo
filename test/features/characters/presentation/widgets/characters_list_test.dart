...
void main() {
  ...
  testWidgets(
      'CharactersList should show a initial message when charactersBloc emit CharactersInitial',
  ...
  testWidgets(
      'CharactersList should show a loadingProgressInidicator when charactersBloc emit CharactersLoading',
      (WidgetTester tester) async {
    Widget _charactersList = Directionality(
      child: MediaQuery(
        data: MediaQueryData(),
  ...
  testWidgets(
      'CharactersList should show a list of CharacterListItems when charactersBloc emit CharactersLoaded',
      (WidgetTester tester) async {
    Widget _charactersList = Directionality(
      child: MediaQuery(
        data: MediaQueryData(),
    ...
    await mockNetworkImagesFor(
        () async => await tester.pumpWidget(_charactersList));
    ...
    expect(loadingFinder, findsNothing);
    expect(
        characterListItem, findsNWidgets(tCharactersLoaded.characters.length));
  });

  testWidgets(
      'CharactersList should show a error message when charactersBloc emit CharactersError',
      (WidgetTester tester) async {
    Widget _charactersList = Directionality(
      child: MediaQuery(
        data: MediaQueryData(),
